...
describe('Create Orphanage', () => {
  ...
  it('Should create an orphanage', async () => {
    ...
    const response = await request(app)
      ...
      .attach('images', path.resolve(__dirname, '..', '2.jpg'))
      .attach('images', path.resolve(__dirname, '..', '3.jpg'))
      .attach('images', path.resolve(__dirname, '..', '4.jpg'))
      .attach('images', path.resolve(__dirname, '..', '5.jpg'))
